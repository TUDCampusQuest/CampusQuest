...
export default function Home() {
  ...
  // 1. Hydration Guard: Ensures client-side code only runs after mounting
  useEffect(() => {
    setIsMounted(true);
  }, []);

  // 2. Safety Check for Locations Data
  // Handles both { locations: [] } and direct [] exports
    ...
    <Box sx={{ height: "100vh", width: "100vw", position: "relative", overflow: "hidden", bgcolor: "#f0f0f0" }}>
      ...
      <Box sx={{ 
        ...
        <Stack direction="row" spacing={1}>
          {/* INFO BUTTON: Navigates to the new Info Page */}
          <IconButton 
            size="small" 
            sx={{ color: "#64748b" }} 
