'use client';
// Fetches and caches all indoor map data (rooms, stairs, floorplans, routing graph) from the API.
...
async function fetchAll() {
    ...
    const [rooms, stairs, floorplans, roomNameMap, locations, campusGraph, buildingRoutes, buildingsData] =
        await Promise.all([
    ...
    cache = {
        rooms, stairs, floorplans, roomNameMap, locations, campusGraph, buildingRoutes,
